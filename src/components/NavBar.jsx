...
export const NavBar = ({ currentModel, hasVideo }) => {
  ...
  return (
    <div
      className={`fixed top-0 left-0 w-full font-bold px-12 p-4 flex justify-between items-center bg-transparent z-40 ${textColorClass} ${
        showDropdown ? "text-black" : ""
      }`}
    ...
    >
      ...
      <div className={`dropdown-bg ${showDropdown ? "show" : ""} z-30`}>
